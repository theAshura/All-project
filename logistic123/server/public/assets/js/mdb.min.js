(jQuery.easing.jswing = jQuery.easing.swing),
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, n, s) {
      ...
      return (
        r * Math.pow(2, -10 * e) * Math.sin(((e * s - a) * (2 * Math.PI)) / o) +
        n +
        i
      );
    },
    ...
    easeInBack: function (t, e, i, n, s, a) {
      return (
        void 0 == a && (a = 1.70158), n * (e /= s) * e * ((a + 1) * e - a) + i
      );
    },
    ...
    easeInOutBack: function (t, e, i, n, s, a) {
      return (
        void 0 == a && (a = 1.70158),
        (e /= s / 2) < 1
          ? (n / 2) * (e * e * (((a *= 1.525) + 1) * e - a)) + i
          : (n / 2) * ((e -= 2) * e * (((a *= 1.525) + 1) * e + a) + 2) + i
      );
    },
...
(Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity),
  jQuery.Velocity
    ...
    : (!(function (t) {
        function e(t) {
          var e = t.length,
            n = i.type(t);
          return 'function' === n || i.isWindow(t)
            ? !1
            : 1 === t.nodeType && e
            ? !0
            : 'array' === n ||
          ...
          (i.isWindow = function (t) {
            ...
            (i.each = function (t, i, n) {
              ...
              if (n) {
                ...
                for (a in t) if (((s = i.call(t[a], a, t[a])), s === !1)) break;
              return t;
            }),
            ...
            (i.queue = function (t, n, s) {
              ...
              if (t) {
                ...
                var o = i.data(t, n);
                return s
                  ? (!o || i.isArray(s) ? (o = i.data(t, n, a(s))) : o.push(s),
                    o)
                  : o || [];
              }
            }),
            ...
            (i.fn = i.prototype =
              {
                ...
                position: function () {
                  ...
                  return (
                    ...
                    t.style &&
                      ((s.top += parseFloat(t.style.borderTopWidth) || 0),
      ...
      (function (t) {
        ...
        return (function (t, e, i, n) {
          ...
          function l(t, i, n, s) {
            ...
            function c() {
              for (var e = 0; b > e; ++e) C[e] = l(e * x, t, n);
            }
            function f(e, i, s) {
              var a,
                o,
            ...
            if (t) {
              ...
              for (var a = 0; i > a; a++)
                if (b.State.calls[a]) {
                  ...
                  for (
                    var m = Math.min((e - d) / h.duration, 1),
                      y = 0,
                      x = l.length;
                    x > y;
                    y++
                    ...
                    if (o(P)) {
                      ...
                      h.visibility !== n &&
                        'hidden' !== h.visibility &&
                        w.setPropertyValue(P, 'visibility', h.visibility);
                      for (var A in S)
                        if ('element' !== A) {
                          var T,
                            F = S[A],
                            M = g.isString(F.easing)
                              ? b.Easings[F.easing]
                              : F.easing;
                          if (1 === m) T = F.endValue;
                          else {
                          ...
                          if (((F.currentValue = T), 'tween' === A)) v = T;
                            ...
                            var O = w.setPropertyValue(
                              P,
                              A,
                              F.currentValue +
                                (0 === parseFloat(T) ? '' : F.unitType),
                              F.rootPropertyValue,
                              F.scrollData,
                            );
                            w.Hooks.registered[A] &&
                              (o(P).rootPropertyValueCache[V] = w.Normalizations
                                .registered[V]
                                ? w.Normalizations.registered[V](
                                    'extract',
                                    null,
                                    O[1],
                                  )
                      ...
                      h.mobileHA &&
                        o(P).transformCache.translate3d === n &&
                        ((o(P).transformCache.translate3d = '(0px, 0px, 0px)'),
                        (k = !0)),
                        k && w.flushTransformCache(P);
                    }
                  }
                  h.display !== n &&
                    'none' !== h.display &&
            ...
            for (
              ...
              if (
                (e ||
                  a.loop ||
                  ('none' === a.display &&
                    w.setPropertyValue(c, 'display', a.display),
                  'hidden' === a.visibility &&
                    w.setPropertyValue(c, 'visibility', a.visibility)),
                a.loop !== !0 &&
                  (f.queue(c)[1] === n ||
                ...
                f.each(w.Lists.transforms3D, function (t, e) {
                  ...
                  o(c).transformCache[e] !== n &&
                    new RegExp('^\\(' + i + '[^.]').test(s) &&
                    ((d = !0), delete o(c).transformCache[e]);
                }),
                  a.mobileHA &&
                    ((d = !0), delete o(c).transformCache.translate3d),
                  d && w.flushTransformCache(c),
                  w.Values.removeClass(c, 'velocity-animating');
              }
              ...
              r && a.loop !== !0 && r(s),
                o(c) &&
                  a.loop === !0 &&
                  !e &&
                  (f.each(o(c).tweensContainer, function (t, e) {
                    /^rotate/.test(t) &&
            ...
            return function n(t, e, s) {
              ...
              for (
                t = parseFloat(t) || 500,
                  ...
                  l.friction = e,
                  a = null !== s,
                  a ? ((u = n(t, e)), (o = (u / s) * f)) : (o = f);
                (r = i(r || l, o)),
                  h.push(1 + r.x),
                  (u += 16),
                  Math.abs(r.x) > c && Math.abs(r.v) > c;
                ...
                if (d)
                  for (i in w.Hooks.templates) {
                    ...
                    'Color' === s[0] &&
                      (s.push(s.shift()),
                      a.push(a.shift()),
                      (w.Hooks.templates[i] = [s.join(' '), a.join(' ')]));
                  }
                for (i in w.Hooks.templates) {
                  (n = w.Hooks.templates[i]), (s = n[0].split(' '));
                  for (var t in s) {
                      ...
                      switch (t) {
                        ...
                        case 'extract':
                          ...
                          if (w.RegEx.wrappedValueAlreadyExtracted.test(s))
                            ...
                            /^[A-z]+$/i.test(s)
                              ? (o = r[s] !== n ? r[s] : r.black)
                              : w.RegEx.isHex.test(s)
                              ? (o =
                                  'rgb(' + w.Values.hexToRgb(s).join(' ') + ')')
                              : /^rgba?\(/i.test(s) || (o = r.black),
                              (a = (o || s)
                                .toString()
            ...
            getPropertyValue: function (t, i, s, a) {
              function r(t, i) {
                ...
                if (8 >= d) l = f.css(t, i);
                  ...
                  (p =
                    ...
                    (l =
                      9 === d && 'filter' === i ? p.getPropertyValue(i) : p[i]),
              ...
              if (w.Hooks.registered[i]) {
                var h = i,
                  u = w.Hooks.getRoot(h);
                s === n &&
                  (s = w.getPropertyValue(t, w.Names.prefixCheck(u)[0])),
                  w.Normalizations.registered[u] &&
                    (s = w.Normalizations.registered[u]('extract', t, s)),
                  (l = w.Hooks.extractValue(h, s));
              } else if (w.Normalizations.registered[i]) {
                var c, p;
                (c = w.Normalizations.registered[i]('name', t)),
                  'transform' !== c &&
                    ((p = r(t, w.Names.prefixCheck(c)[0])),
              ...
              return (
                ...
                f.each(t, function (t, a) {
                  if ((o(a) === n && b.init(a), i === n))
                    ...
                    'transform' === r[0] && b.CSS.flushTransformCache(a),
                      (s = r);
                  }
                }),
                s
          ...
          var S = function () {
            ...
            function s() {
              function t(t) {
                    ...
                    g.isArray(t)
                      ? ((i = t[0]),
                        ...
                        w.RegEx.isHex.test(t[1])
                          ? (o = t[1])
                          : ((g.isString(t[1]) && !w.RegEx.isHex.test(t[1])) ||
                              g.isArray(t[1])) &&
                            ((s = e ? t[1] : h(t[1], r.duration)),
                            t[2] !== n && (o = t[2])))
                      : (i = t),
                    e || (s = s || r.easing),
                    g.isFunction(i) && (i = i.call(a, P, C)),
                    g.isFunction(o) && (o = o.call(a, P, C)),
                    [i || 0, s, o]
                  );
                }
                function d(t, e) {
                ...
                function m() {
                  var t = {
                    ...
                    n =
                      t.position === O.lastPosition &&
                      t.myParent === O.lastParent,
                    s = t.fontSize === O.lastFontSize;
                  (O.lastParent = t.myParent),
                    (O.lastPosition = t.position),
                    (O.lastFontSize = t.fontSize);
                  var r = 100,
                    l = {};
                  if (s && n)
                    ...
                    b.init(h),
                      ...
                      (l.percentToPxWidth = O.lastPercentToPxWidth =
                        (parseFloat(w.getPropertyValue(h, 'width', null, !0)) ||
                          1) / r),
                      (l.percentToPxHeight = O.lastPercentToPxHeight =
                        (parseFloat(
                          w.getPropertyValue(h, 'height', null, !0),
                        ) || 1) / r),
                      (l.emToPx = O.lastEmToPx =
                        (parseFloat(w.getPropertyValue(h, 'paddingLeft')) ||
                          1) / r),
                  ...
                  return (
                    null === O.remToPx &&
                      (O.remToPx =
                        parseFloat(w.getPropertyValue(i.body, 'fontSize')) ||
                        16),
                    null === O.vwToPx &&
                      ((O.vwToPx = parseFloat(e.innerWidth) / 100),
                      (O.vhToPx = parseFloat(e.innerHeight) / 100)),
                    (l.remToPx = O.remToPx),
                    (l.vwToPx = O.vwToPx),
                    (l.vhToPx = O.vhToPx),
                    b.debug >= 1 &&
                ...
                if ('scroll' === T) {
                  var S,
                    k,
                    L,
                    F = /^x$/i.test(r.axis) ? 'Left' : 'Top',
                    M = parseFloat(r.offset) || 0;
                  r.container
                    ? g.isWrapped(r.container) || g.isNode(r.container)
                      ? ((r.container = r.container[0] || r.container),
                        (S = r.container['scroll' + F]),
                        (L = S + f(a).position()[F.toLowerCase()] + M))
                      : (r.container = null)
                    : ((S =
                        b.State.scrollAnchor[b.State['scrollProperty' + F]]),
                      (k =
                        b.State.scrollAnchor[
                          b.State[
                  ...
                  'none' === o(a).opts.display && (o(a).opts.display = 'auto'),
                    'hidden' === o(a).opts.visibility &&
                      (o(a).opts.visibility = 'visible'),
                    (o(a).opts.loop = !1),
                    (o(a).opts.begin = null),
                    (o(a).opts.complete = null),
                    y.easing || delete r.easing,
                    y.duration || delete r.duration,
                    (r = f.extend({}, o(a).opts, r));
                  ...
                  for (var V in E)
                    if ('element' !== V) {
                      ...
                      (E[V].startValue = E[V].currentValue = E[V].endValue),
                        (E[V].endValue = R),
                        g.isEmptyObject(y) || (E[V].easing = r.easing),
                        b.debug &&
                          console.log(
                        ...
                        if (w.RegEx.isHex.test(s)) {
                          for (
                            var r = ['Red', 'Green', 'Blue'],
                              l = w.Values.hexToRgb(s),
                              h = o ? w.Values.hexToRgb(o) : n,
                              u = 0;
                            u < r.length;
                            u++
                          ) {
                  ...
                  for (var W in v) {
                    ...
                    if (
                      o(a).isSVG ||
                      'tween' === N ||
                      w.Names.prefixCheck(N)[1] !== !1 ||
                      w.Normalizations.registered[N] !== n
                    ) {
                      ((r.display !== n &&
                        null !== r.display &&
                        'none' !== r.display) ||
                        (r.visibility !== n && 'hidden' !== r.visibility)) &&
                        /opacity|filter/.test(W) &&
                        !j &&
                        0 !== B &&
                        (j = 0),
                        r._cacheValues && E && E[W]
                          ? (j === n && (j = E[W].endValue + E[W].unitType),
                            (D = o(a).rootPropertyValueCache[N]))
                          : w.Hooks.registered[W]
                          ? j === n
                            ? ((D = w.getPropertyValue(a, N)),
                              (j = w.getPropertyValue(a, W, D)))
                            : (D = w.Hooks.templates[N][1])
                          : j === n && (j = w.getPropertyValue(a, W));
                      var q,
                        X,
                        Y,
                        $ = !1;
                      if (
                        ...
                        (B = parseFloat(B) || 0),
                        '%' === X &&
                          (/^(fontSize|lineHeight)$/.test(W)
                            ? ((B /= 100), (X = 'em'))
                            : /^scale/.test(W)
                            ? ((B /= 100), (X = ''))
                            : /(Red|Green|Blue)$/i.test(W) &&
                              ((B = (B / 100) * 255), (X = ''))),
                        /[\/*]/.test($))
                      )
                        X = Y;
                ...
                l.element &&
                  ...
                  z.push(l),
                  '' === r.queue &&
                    ((o(a).tweensContainer = l), (o(a).opts = r)),
                  (o(a).isAnimating = !0),
                  P === C - 1
                    ? (b.State.calls.push([z, p, r, null, A.resolver]),
                      b.State.isTicking === !1 &&
              ...
              b.mock !== !1 &&
                (b.mock === !0
                  ...
                  : ((r.duration *= parseFloat(b.mock) || 1),
                    (r.delay *= parseFloat(b.mock) || 1))),
                (r.easing = h(r.easing, r.duration)),
                r.begin && !g.isFunction(r.begin) && (r.begin = null),
                r.progress && !g.isFunction(r.progress) && (r.progress = null),
                r.complete && !g.isFunction(r.complete) && (r.complete = null),
                r.display !== n &&
                  null !== r.display &&
                  ((r.display = r.display.toString().toLowerCase()),
                  'auto' === r.display &&
                    (r.display = b.CSS.Values.getDisplayType(a))),
                r.visibility !== n &&
                  null !== r.visibility &&
                  (r.visibility = r.visibility.toString().toLowerCase()),
                (r.mobileHA =
                  r.mobileHA && b.State.isMobile && !b.State.isGingerbread),
                r.queue === !1
                  ? r.delay
                    ? setTimeout(t, r.delay)
                    : t()
                  : f.queue(a, r.queue, function (e, i) {
                      return i === !0
                        ? (A.promise && A.resolver(p), !0)
                        : ((b.velocityQueueEntryFlag = !0), void t(e));
                    }),
                ('' !== r.queue && 'fx' !== r.queue) ||
                  'inprogress' === f.queue(a)[0] ||
                  f.dequeue(a);
            }
            var r,
              l,
            ...
            if (
              ...
              x
                ? ((v = arguments[0].properties || arguments[0].p),
                  (y = arguments[0].options || arguments[0].o))
                : ((v = arguments[d]), (y = arguments[d + 1]));
              var C = p.length,
                P = 0;
              if (!/^(stop|finish)$/i.test(v) && !f.isPlainObject(y)) {
                ...
                for (var L = k; L < arguments.length; L++)
                  g.isArray(arguments[L]) ||
                  (!/^(fast|normal|slow)$/i.test(arguments[L]) &&
                    !/^\d/.test(arguments[L]))
                    ? g.isString(arguments[L]) || g.isArray(arguments[L])
                      ? (y.easing = arguments[L])
                      : g.isFunction(arguments[L]) &&
                        (y.complete = arguments[L])
                    : (y.duration = arguments[L]);
              }
              ...
              switch (v) {
                ...
                case 'stop':
                  ...
                  return (
                    f.each(b.State.calls, function (t, e) {
                      e &&
                        f.each(e[1], function (i, s) {
                          var a = y === n ? '' : y;
                          return a === !0 ||
                            e[2].queue === a ||
                            (y === n && e[2].queue === !1)
                            ? void f.each(p, function (i, n) {
                                n === s &&
                                  ((y === !0 || g.isString(y)) &&
                                    (f.each(
                                      f.queue(n, g.isString(y) ? y : ''),
                                      function (t, e) {
                                  ...
                                  'stop' === v
                                    ? (o(n) &&
                                      ...
                                      F.push(t))
                                    : 'finish' === v && (e[2].duration = 1));
                              })
                            : !0;
                        });
                    }),
                    'stop' === v &&
                      (f.each(F, function (t, e) {
                        c(e, !0);
                      }),
                ...
                default:
                  if (!f.isPlainObject(v) || g.isEmptyObject(v)) {
                      ...
                      return (
                        ...
                        f.each(p, function (t, e) {
                          parseFloat(M.stagger)
                            ? (M.delay = V + parseFloat(M.stagger) * t)
                            : g.isFunction(M.stagger) &&
                              (M.delay = V + M.stagger.call(e, t, C)),
                            M.drag &&
                              ((M.duration =
                                parseFloat(E) ||
                                (/^(callout|transition)/.test(v) ? 1e3 : m)),
                              (M.duration = Math.max(
                                M.duration *
                                  (M.backwards ? 1 - t / C : (t + 1) / C),
                                0.75 * M.duration,
                                200,
                              ))),
                            b.Redirects[v].call(
                    ...
                    return (
                      A.promise ? A.rejecter(new Error(R)) : console.log(R), t()
                    );
                  }
                  T = 'start';
              }
          ...
          return (
            ...
            (t.Velocity = b),
            t !== e &&
              ((t.fn.velocity = S), (t.fn.velocity.defaults = b.defaults)),
  ...
  function () {
    ...
    var t = this,
      ...
      i = function (t) {
        ...
        return (
          (s = this.width = t.canvas.width),
          (a = this.height = t.canvas.height),
    ...
    var n = (i.helpers = {}),
      ...
      P =
        ((n.getAngleFromPoint = function (t, e) {
          ...
          return (
            0 > i && 0 > n && (a += 2 * Math.PI), { angle: a, distance: s }
          );
        }),
        ...
        ((n.calculateScaleRange = function (t, e, i, n, a) {
          ...
          for (
            var f = Math.abs(c - u),
              ...
              g = n
                ? 0
                : Math.floor(u / (1 * Math.pow(10, d))) * Math.pow(10, d),
              v = p - g,
              m = Math.pow(10, d),
              x = Math.round(v / m);
            (x > r || r > 2 * x) && !l;
          ...
          return (
            l && ((x = o), (m = v / x)),
            { steps: x, stepValue: m, min: g, max: g + x * m }
          );
        }),
      ...
      z =
        ...
        (n.animationLoop = function (t, e, i, n, s, a) {
          var o = 0,
            ...
            l = function () {
              ...
              t.call(a, h, i, o),
                n.call(a, h, i),
                e > o ? (a.animationFrame = E(l)) : s.apply(a);
            };
          E(l);
        }),
        (n.getRelativePosition = function (t) {
          ...
          return (
            n.touches
              ? ((e = n.touches[0].clientX - a.left),
                (i = n.touches[0].clientY - a.top))
              : ((e = n.clientX - a.left), (i = n.clientY - a.top)),
            { x: e, y: i }
          );
        }),
    ...
    (i.instances = {}),
          ...
          if (a || e) {
            if (
              ...
              if (this.datasets && this.datasets.length > 1) {
                for (
                  var o, r, h = this.datasets.length - 1;
                  h >= 0 &&
                  ((o =
                      ...
                      n.each(
                        ...
                        function (t) {
                          s.push(t.x),
                            a.push(t.y),
                            u.push(
                              n.template(this.options.multiTooltipTemplate, t),
                            ),
                            c.push({
      ...
      (i.Tooltip = i.Element.extend({
        draw: function () {
          ...
          (t.font = Y(this.fontSize, this.fontStyle, this.fontFamily)),
            (this.xAlign = 'center'),
            (this.yAlign = 'above');
          ...
          if (((t.fillStyle = this.fillColor), this.custom)) this.custom(this);
            ...
            Q(t, a, o, i, n, this.cornerRadius),
              t.fill(),
              (t.fillStyle = this.textColor),
              (t.textAlign = 'center'),
              (t.textBaseline = 'middle'),
              t.fillText(this.text, a + i / 2, o + n / 2);
          }
        },
      })),
      ...
      (i.Scale = i.Element.extend({
        ...
        buildYLabels: function () {
          ...
          this.yLabelWidth =
            this.display && this.showLabels
              ? $(this.ctx, this.font, this.yLabels) + 10
              : 0;
        },
        ...
        calculateXLabelRotation: function () {
          ...
          var i,
            ...
            e = this.ctx.measureText(
              this.xLabels[this.xLabels.length - 1],
            ).width;
          if (
            ((this.xScalePaddingRight = e / 2 + 3),
            (this.xScalePaddingLeft =
              t / 2 > this.yLabelWidth ? t / 2 : this.yLabelWidth),
            (this.xLabelRotation = 0),
            this.display)
          ) {
            var a,
              s = $(this.ctx, this.font, this.xLabels);
            this.xLabelWidth = s;
            for (
              ...
              (a = Math.cos(S(this.xLabelRotation))),
                (i = a * t),
                (n = a * e),
                i + this.fontSize / 2 > this.yLabelWidth &&
                  (this.xScalePaddingLeft = i + this.fontSize / 2),
                (this.xScalePaddingRight = this.fontSize / 2),
                this.xLabelRotation++,
                (this.xLabelWidth = a * s);
            this.xLabelRotation > 0 &&
              (this.endPoint -= Math.sin(S(this.xLabelRotation)) * s + 3);
          } else
            (this.xLabelWidth = 0),
            ...
            (e = this.getPointPosition(i, t)),
              (n =
                this.ctx.measureText(
                  T(this.templateString, { value: this.labels[i] }),
                ).width + 5),
                      ...
                      if (
                        ...
                        for (var o = 0; o < this.valuesCount; o++)
                          (a = this.getPointPosition(
                            ...
                            0 === o ? t.moveTo(a.x, a.y) : t.lineTo(a.x, a.y);
              ...
              for (var e = this.valuesCount - 1; e >= 0; e--) {
                ...
                if (
                  (this.angleLineWidth > 0 &&
                    ((i = this.calculateCenterOffset(this.max)),
                    (n = this.getPointPosition(e, i)),
                    t.beginPath(),
                  ...
                  null == i && (i = this.calculateCenterOffset(this.max)),
                    null == n && (n = this.getPointPosition(e, i));
                  var a = this.getPointPosition(
                      0 === e ? this.valuesCount - 1 : e - 1,
                      i,
                    ),
                    o = this.getPointPosition(
                      e === this.valuesCount - 1 ? 0 : e + 1,
                      i,
                    ),
                  ...
                  t.beginPath(),
                    ...
                    t.lineTo(n.x, n.y),
                    t.lineTo(l.x, l.y),
                    (t.fillStyle = this.backgroundColors[e]),
                    t.fill(),
                    t.closePath();
                }
      ...
      (i.animationService = {
        ...
        addAnimation: function (t, e) {
          ...
          this.animations.push({ chartInstance: t, animationObject: e }),
            1 == this.animations.length &&
              n.requestAnimFrame.call(window, this.digestWrapper);
        },
        ...
        startDigest: function () {
          var t = Date.now(),
            e = 0;
          this.dropFrames > 1 &&
            ((e = Math.floor(this.dropFrames)), (this.dropFrames -= e));
          for (var i = 0; i < this.animations.length; i++)
      ...
      initialize: function (t) {
        ...
        (this.ScaleClass = e.Scale.extend({
          ...
          calculateBaseWidth: function () {
            return (
              this.calculateX(1) - this.calculateX(0) - 2 * n.barValueSpacing
            );
          },
    ...
    e.Type.extend({
      ...
      initialize: function (t) {
        (this.segments = []),
          ...
          i.each(
            ...
            function (e, i) {
              e.color ||
                (e.color = 'hsl(' + (360 * i) / t.length + ', 100%, 50%)'),
                this.addData(e, i, !0);
            },
            this,
          ),
      ...
      addData: function (t, i, n) {
        ...
        'undefined' == typeof t.color &&
          ((t.color =
            e.defaults.global.segmentColorDefault[
              s % e.defaults.global.segmentColorDefault.length
            ]),
          (t.highlight =
            e.defaults.global.segmentHighlightColorDefaults[
              s % e.defaults.global.segmentHighlightColorDefaults.length
            ])),
      ...
      e.types.Doughnut.extend({
        name: 'Pie',
        defaults: i.merge(n, { percentageInnerCutout: 0 }),
      });
  }.call(this),
  function () {
    'use strict';
            ...
            function (t) {
              ...
              i.each(
                ...
                this.options.datasetFill &&
                  r.length > 0 &&
                  (n.lineTo(r[r.length - 1].x, this.scale.endPoint),
                  n.lineTo(r[0].x, this.scale.endPoint),
      ...
      addData: function (t, e) {
        this.scale.valuesCount++,
          i.each(
            t,
            function (t, i) {
              var n = this.scale.getPointPosition(
                this.scale.valuesCount,
              ...
              (s = e[i]),
                ...
                n.push(
                  function () {
                    var e, n, o, r;
                    for (
                      o = this.vendors, r = [], e = 0, n = o.length;
                      n > e;
                      e++
                    )
                      (a = o[e]),
                        r.push(
                          (t['' + a + i.charAt(0).toUpperCase() + i.substr(1)] =
                            s),
                        );
                    return r;
                  }.call(this),
      ...
      if (null !== e) {
        ...
        if ((p.registerEvent(t), 'touchstart' === t.type && c.delay)) {
          var i = !1,
            ...
            a = function (n) {
              s && (clearTimeout(s), (s = null), c.show(t, e)),
                i || ((i = !0), c.hide(n, e));
            },
            o = function (t) {
          ...
          c.show(t, e),
            n &&
              (e.addEventListener('touchend', c.hide, !1),
              e.addEventListener('touchcancel', c.hide, !1)),
            e.addEventListener('mouseup', c.hide, !1),
            e.addEventListener('mouseleave', c.hide, !1);
      }
    }
    var t = t || {},
      ...
      c = {
        ...
        show: function (t, e, i) {
          ...
          'touches' in t && t.touches.length
            ? ((a = t.touches[0].pageY - s.top),
              (o = t.touches[0].pageX - s.left))
            : ((a = t.pageY - s.top), (o = t.pageX - s.left)),
            (o = o >= 0 ? o : 0),
            (a = a >= 0 ? a : 0);
          ...
          n.classList.add('waves-notransition'),
            n.setAttribute('style', u(f)),
            n.classList.remove('waves-notransition'),
            (f['-webkit-transform'] = r + ' ' + l),
            (f['-moz-transform'] = r + ' ' + l),
            (f['-ms-transform'] = r + ' ' + l),
            (f['-o-transform'] = r + ' ' + l),
            (f.transform = r + ' ' + l),
          ...
          (f['-webkit-transition-duration'] = d + 'ms'),
            (f['-moz-transition-duration'] = d + 'ms'),
            (f['-o-transition-duration'] = d + 'ms'),
            (f['transition-duration'] = d + 'ms'),
            n.setAttribute('style', u(f));
        },
        hide: function (t, e) {
          e = e || this;
          for (
            var i = e.getElementsByClassName('waves-rippling'),
              n = 0,
              s = i.length;
            s > n;
            n++
        ...
        input: function (t) {
          ...
          if (
            ...
            var n = window.getComputedStyle(t, null),
              s = n.color,
              a = n.backgroundColor;
            i.setAttribute('style', 'color:' + s + ';background:' + a),
      ...
      p = {
        ...
        allowEvent: function (t) {
          var e = !0;
          return (
            /^(mousedown|mousemove)$/.test(t.type) && p.touches && (e = !1), e
          );
        },
    ...
    return (
      (t.init = function (t) {
        ...
        (t = t || {}),
          ...
          'delay' in t && (c.delay = t.delay),
          n &&
            (e.addEventListener('touchstart', v, !1),
            e.addEventListener('touchcancel', p.registerEvent, !1),
            e.addEventListener('touchend', p.registerEvent, !1)),
      ...
      (t.calm = function (t) {
        t = l(t);
        for (
          var e = { type: 'mouseup', button: 1 }, i = 0, n = t.length;
          n > i;
          i++
        )
          c.hide(e, t[i]);
  ...
  Waves.attach(
    '.navbar-nav a, .nav-icons li a, .navbar form, .nav-tabs .nav-item',
    ['waves-light'],
  ),
