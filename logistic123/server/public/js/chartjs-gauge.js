...
(function (global, factory) {
  ...
  */
    drawNeedle: function drawNeedle(ease) {
      ...
      var needleLength =
        (lengthPercentage / 100) * (outerRadius - innerRadius) + innerRadius; // center
    ...
    updateElement: function updateElement(arc, index, reset) {
      ...
      Chart.controllers.doughnut.prototype.updateElement.call(
        this,
        arc,
        index,
        reset,
      ...
      var startAngle =
        options.rotation + options.circumference * (previousValue / maxValue);
      var endAngle =
        startAngle +
        options.circumference * ((value - previousValue) / maxValue);
