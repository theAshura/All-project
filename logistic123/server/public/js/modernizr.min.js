...
window.Modernizr = (function (n, t, i) {
  ...
  function f(n, t, i) {
    ...
    return h(t, 'string') || h(t, 'undefined')
      ? lt(u, t)
      : ((u = (n + ' ' + st.join(r + ' ') + r).split(' ')), pt(u, t, i));
  }
  function wt() {
    (u.input = (function (i) {
  ...
  var at = '2.8.3',
    ...
    d;
  (k =
    h(rt, 'undefined') || h(rt.call, 'undefined')
      ? function (n, t) {
          ...
          (r = function () {
            ...
            return this instanceof r
              ? ((f = function () {}),
                ...
                (e = new f()),
                (u = t.apply(e, i.concat(it.call(arguments)))),
                Object(u) === u)
                ? u
                : e
              : t.apply(n, i.concat(it.call(arguments)));
          }),
          r
        );
      }),
    ...
    (r.cssgradients = function () {
      ...
      return (
        a(
          (n + '-webkit- '.split(' ').join(t + n) + y.join(i + n)).slice(
            0,
            -n.length,
          ),
        ),
      ...
      function l(n, r, u) {
        ...
        return (
          (f = u.cache[n]
            ...
            : u.createElem(n)),
          f.canHaveChildren && !y.test(n) && !f.tagUrn
