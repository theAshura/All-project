...
import { clearEventTypeErrorsReducer } from '../../../store/event-type/event-type.action';
import {
...
interface EventTypeFormProps {
  isEdit: boolean;
  isCreate?: boolean;
  data: EventTypeDetailResponse;
  onSubmit: (CreateEventTypeParams) => void;
  loading?: boolean;
}
...
const EventTypeForm: FC<EventTypeFormProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(clearEventTypeErrorsReducer());
    };
  ...
  const handleSubmitAndNew = (data: EventType) => {
    const dataNew: EventType = { ...data, isNew: true, resetForm };
    onSubmit(dataNew);
  };
