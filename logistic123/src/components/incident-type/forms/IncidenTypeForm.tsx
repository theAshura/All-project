...
interface FleetFormProps {
  ...
  onSubmit: (CreateIncidentTypeParams) => void;
  loading?: boolean;
}
    ...
    if (errorList?.length) {
      errorList.forEach((item) => {
        switch (item.fieldName) {
          case 'code':
            setError('code', { message: t('incidentTypeCodeIsExisted') });
            break;
          case 'name':
            setError('name', { message: t('incidentTypeNameIsExisted') });
            break;
          default:
            break;
        }
