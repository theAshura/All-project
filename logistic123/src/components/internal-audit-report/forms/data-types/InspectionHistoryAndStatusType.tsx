...
import { v4 } from 'uuid';
import IHASList from '../inspection-history-and-status/IHASList';
import ManuallyCreatedRecordTable from '../inspection-history-and-status/ManuallyCreatedRecordTable';
import ModalEditHistoryAndStatus from '../inspection-history-and-status/ModalEditHistoryAndStatus';
...
const InspectionHistoryAndStatusType: FC<Props> = ({
  isEdit,
  dynamicLabels,
}) => {
      ...
      <div className={styles.formContainer}>
        <div className="d-flex flex-row justify-content-between align-items-center">
          ...
          <div className={cx('d-flex flex-row', styles.datePickerWrapper)}>
            <div
              className={cx('d-flex flex-row align-items-center', styles.date)}
            >
              <span>
                {renderDynamicLabel(
                  dynamicLabels,
...
export default InspectionHistoryAndStatusType;
