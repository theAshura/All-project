...
import { clearLocationErrorsReducer } from '../../../store/location/location.action';
import {
  Location,
...
interface LocationFormProps {
  ...
  onSubmit: (CreateLocationParams) => void;
}
...
const LocationForm: FC<LocationFormProps> = ({
  ...
  const { errorList, loading } = useSelector((state) => state.location);
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(clearLocationErrorsReducer());
    };
  ...
  return loading && !isCreate ? (
    ...
    <div className={cx(styles.wrapperContainer)}>
      ...
      {/* <ModalConfirm
        ...
        modal={modal}
        handleSubmit={() => history.push(AppRouteConst.LOCATION)}
        title={t('cancelTitle')}
