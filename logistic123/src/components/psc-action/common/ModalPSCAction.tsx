...
const ModalPSCAction: FC<ModalPSCActionProps> = (props) => {
  const {
    loading,
    isCreate,
    toggle,
  ...
  const { errorList } = useSelector((state) => state.pscAction);
            ...
            if (res.data.isExist) {
              switch (field) {
                case 'code':
                  if (value !== data?.code) {
                    setError(field, {
                      message: t('pscActionCodeIsExisted'),
                    });
                  }
                  break;
                case 'name':
                  if (value !== data?.name) {
                    setError(field, {
                      message: t('pscActionNameIsExisted'),
                    });
                  }
                  break;
                default:
