...
import ChartOwnerForm from '../forms/ThirdCategoryForm';
...
export default function ChartOwnerCreate() {
  ...
  const handleSubmit = useCallback(
    (formData: CreateThirdCategoryParams) => {
      dispatch(createThirdCategoryActions.request(formData));
    },
    [dispatch],
  );
    ...
    <div className={styles.chartOwnerCreate}>
      <Container>
        <div className={cx(styles.headers)}>
          <BreadCrumb current={BREAD_CRUMB.THIRD_CATEGORY_CREATE} />
