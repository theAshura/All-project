...
import { clearThirdCategoryErrorsReducer } from 'store/third-category/third-category.action';
import images from 'assets/images/images';
import isEqual from 'lodash/isEqual';
import styles from './form.module.scss';

interface ThirdCategoryFormProps {
  isEdit: boolean;
  isCreate?: boolean;
  data: ThirdCategoryDetailResponse;
  onSubmit: (CreateThirdCategoryParams) => void;
}
...
const ThirdCategoryForm: FC<ThirdCategoryFormProps> = ({
  isEdit,
  data,
  onSubmit,
  isCreate,
  ...
  const { errorList, loading } = useSelector((state) => state.thirdCategory);
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(clearThirdCategoryErrorsReducer());
    };
