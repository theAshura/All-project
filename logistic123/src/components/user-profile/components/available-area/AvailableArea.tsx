...
const AvailableArea: FC<AvailableProps> = ({ onSubmit, dynamicLabels }) => {
  ...
  return (
    <div className={styles.accountInformation}>
      <div className={styles.accountInformationContainer}>
        <Row>
          <Col>
            <Preference typePreference="strong" dynamicLabels={dynamicLabels} />
          </Col>
          <Col>
            <Preference
          ...
          <Col>
            <Preference typePreference="no" dynamicLabels={dynamicLabels} />
          </Col>
        </Row>
      </div>
