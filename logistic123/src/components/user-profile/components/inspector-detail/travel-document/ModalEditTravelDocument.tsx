...
const ModalEditTravelDocument: FC<ModalComponentProps> = ({
  ...
  const [attachmentsState, setAttachments] = useState([]);
  ...
  return (
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <TableAttachment
          value={attachmentsState}
          featurePage={Features.USER_ROLE}
          subFeaturePage={SubFeatures.USER}
          ...
          isEdit={!(disabled || viewOnly || !isEditFile)}
          dynamicLabels={dynamicLabels}
        />
        <Col xs={12} className={styles.label}>
          Verified<span className={styles.dotRequired}>*</span>
        </Col>
