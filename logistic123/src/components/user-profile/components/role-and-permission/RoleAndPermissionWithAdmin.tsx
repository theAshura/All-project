...
const RoleAndPermissionWithAdmin: FC<Props> = ({
  ...
  useEffect(() => {
    if (userDetailResponse?.roles && companyList?.length) {
      getList();
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [userDetailResponse, companyList]);
  ...
  return (
    <div className={styles.wrap}>
      <Button
        disabled={
          loading || isDisabled || userInfo.roleScope === RoleScope.User
        }
        disabledCss={
          loading || isDisabled || userInfo.roleScope === RoleScope.User
        }
      ...
      <ModalAddRole
        ...
        parentCompanySelected={userDetailResponse?.companyId}
        switchableCompanies={[]}
        onClose={() => {
