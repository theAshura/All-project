...
import { RoleScope, LIST_INSPECTORS } from 'constants/roleAndPermission.const';
...
const RoleAndPermission: FC<RoleAndPermissionProps> = ({
  ...
  const { listRolePermissionDetail } = useSelector((state) => state.user);
        ...
        render={({ field: { value, onChange } }) => (
          <Container>
            <div className={styles.roleAndPermission}>
              ...
              {errors?.roles?.message && statusPage !== StatusPage.VIEW && (
